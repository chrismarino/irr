  ...
  return (
    <Layout>
      ...
      <div style={{ alignItems: 'center' }}>
        <h3>More information about Rocket Rewards: <a href="https://github.com/chrismarino/rocketreturns/blob/main/About.md" style={{ color: '#72d5fa' }}> here</a></h3>
        <h1 id="rocket-pool-node-and-minipool-irr-calculator">Rocket Pool Node and Minipool IRR Calculator</h1>
        <p>An app that calculates the IRR of a Ethereum validator node running the <a href="https://rocketpool.net/">Rocket Pool</a> Liquid Staking Protocol.</p>
        ...
        <ol>
          ...
          <li>RPL staking </li>
          <li>Claimed and unclained periodic reward, </li>
        ...
        <p>These values are calculated for the node in native Etherum and RPL, as well as in fiat currency (USD). The IRR calculations use the token price on the day of the event to calculate the fiat value of the event. Price for the day is the midpoint between the high and low for the day as provided by the pubic <a href="https://www.coinbase.com/cloud">coinbase</a> pricing API. The fiat IRR is then calculated using the values of the fiat flows.</p>
        ...
        <ul>
          ...
          <li>Unclaimed Smoothing Pool Rewards: Allocated share of node&#39;s unclained Smoothing Pool rewards to Minipool. Based on the daily weighed average of Minipool bond and total bond across all active Minipools during the interval.</li>
          ...
          <li>Unclaimed RPL Inflation: Allocated share of unclained RPL Inflation rewards to Minipool. Based on daily weighed average of Minipool bond and total bond across all active Minipools during the interval.</li>
