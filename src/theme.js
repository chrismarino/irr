...
const makeTheme = (mode) =>
  createTheme({
    ...
    palette: {
      ...
      primary: green,
      background: {
        default: mode === "dark" ? "#1c1d37" : "#fafafa",
      },
      rpl: {
        main: deepOrange[400],
    ...
    components: {
      MuiAppBar: {
        styleOverrides: {
          root: {
            backgroundColor: '#1c1d37', // replace '#yourColor' with your desired color
          },
        },
      },
      MuiAlert: {
      ...
      MuiTooltip: {
        styleOverrides: {
          tooltip: {
            backgroundColor: mode === "dark" ? "#1c1d37" : "#eaeaea",
          },
          arrow: {
            color: mode === "dark" ? "#1c1d37" : "#eaeaea",
          },
        },
      },
    },
